        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dr.HasRows)
                {
                    ...
                    DialogResult dialogResult = MessageBox.Show("\tWelcome " + dr.GetValue(3).ToString() + " \n Time & Date Login : " + DateTime.Now.ToString() + "", "EnrollMe", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    dr.Close();
                    getuID();
                    insertToLogTrail();
                    updateStatus();
